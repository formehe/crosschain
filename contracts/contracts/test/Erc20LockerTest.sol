...
contract Erc20LockerTest is ERC20Locker {
    ...
    function conversionFromAssetAmountTest1(address _fromAssetHash,uint256 amount,bool isLock) public view returns(uint256 transferAmount,uint256 conversionAmount){
